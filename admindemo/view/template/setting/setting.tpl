	...
	<div class="box">
		...
		<div class="content">
			<div id="tabs" class="htabs">
				...
				<a href="#tab-fraud"><?php echo $tab_fraud; ?></a><a href="#tab-server"><?php echo $tab_server; ?></a>
			</div>
			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<div id="tab-general">
					<table class="form">
						<tr>
							...
							<tr>
								<td><span class="required">*</span><b><?php echo $entry_email; ?></b></td>
							...
							<tr>
								<td><span class="required">*</span><b><?php echo $entry_telephone; ?></b></td>
				...
				<div id="tab-store">
					<table class="form">
						<tr>
							<td><span class="required">*</span><b><?php echo $entry_title; ?></b></td>
						...
						<tr>
							<td><b><?php echo $entry_layout; ?></b></td>
			...
			<div id="tab-local">
				<table class="form">
					<tr>
						<td><b><?php echo $entry_language; ?></b></td>
					...
					<tr>
						<td><b><?php echo $entry_admin_language; ?></b></td>
