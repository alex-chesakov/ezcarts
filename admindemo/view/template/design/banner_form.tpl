		...
		<div class="content">
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<table class="form">
					...
					<tr><td><?php echo $column_filename; ?></td><td><input type="text" name="filename" value="<?php echo $filename; ?>" size="100" /></td></tr>
					<tr>
						...
						<tbody id="image-row<?php echo $image_row; ?>">
							...
							<?php foreach ($languages as $language) { ?>
								<tr>
									<td colspan="3">
										<div>
											<textarea name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][html_desc]" style="width:100%;"><?php echo isset($banner_image['banner_image_description'][$language['language_id']]) ? $banner_image['banner_image_description'][$language['language_id']]['html_desc'] : ''; ?></textarea>
...
function addImage() {
	...
	<?php foreach ($languages as $language) { ?>
		html += '<tr>';
		html += '<td colspan="3">';
		html += '<textarea name="banner_image[' + image_row + '][banner_image_description][<?php echo $language['language_id']; ?>][html_desc]" style="width:100%"></textarea>';
		html += '</td>';
		html += '<td>';
