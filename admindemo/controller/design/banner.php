...
$this->data['column_filename'] = $this->language->get('column_filename');
		...
		if (isset($this->request->post['name'])) {$this->data['name'] = $this->request->post['name'];} elseif (!empty($banner_info)) {$this->data['name'] = $banner_info['name'];} else {$this->data['name'] = '';}
		if (isset($this->request->post['filename'])) {$this->data['filename'] = $this->request->post['filename'];} elseif (!empty($banner_info)) {$this->data['filename'] = $banner_info['filename'];} else {$this->data['filename'] = '';}
