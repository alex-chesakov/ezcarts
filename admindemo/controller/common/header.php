...
$this->data['logged'] = $this->user->getUserName();//sprintf($this->language->get('text_logged'), $this->user->getUserName());
			$this->data['pp_express_status'] = $this->config->get('pp_express_status');
$this->data['locations'] = $this->url->link('tool/location', 'token=' . $this->session->data['token'], 'SSL');
$this->data['analytics'] = $this->url->link('tool/analytics', 'token=' . $this->session->data['token'], 'SSL');
...
$this->data['ordercollector'] = $this->url->link('sale/ordercollector', 'token=' . $this->session->data['token'], 'SSL');
