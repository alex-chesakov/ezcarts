...
// Error
$_['error_upload_1']        = 'Attention: The uploaded file exceeds the upload_max_filesize directive in php.ini!';
$_['error_upload_2']        = 'Attention: The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form!';
$_['error_upload_3']        = 'Attention: The uploaded file was only partially uploaded!';
$_['error_upload_4']        = 'Attention: No file was uploaded!';
$_['error_upload_6']        = 'Attention: Missing a temporary folder!';
$_['error_upload_7']        = 'Attention: Failed to write file to disk!';
$_['error_upload_8']        = 'Attention: File upload stopped by extension!';
$_['error_upload_999']      = 'Attention: No error code available!';
?>