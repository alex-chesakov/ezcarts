...
<?php /*
			<div  class="flex">
				...
				<?php for($r=0;$r<$product_rating;$r++){ ?>
					<button class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none  focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:text-accent-foreground h-9 rounded-md p-0 hover:bg-transparent">
...
*/	?>			
		...
		<a href="<?php echo $go_shop;?>" class="justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none  focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:text-accent-foreground h-10 px-4 py-2 flex items-center gap-2 hover:bg-gray-100">
			...
			<div class="border rounded-lg p-6 product_info">
				<div class="space-y-6 closest_price">
					<div class="flex items-center justify-between">
						...
						<?php if(!empty($product_price)){ ?>
							<div class="b_select_style">
								<button class="flex h-10 items-center justify-between rounded-md border border-input bg-white px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none  focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&amp;>span]:line-clamp-1 w-[180px]">
									<span style="pointer-events: none;" class="to_type_price"><?php if($product_price_type == 'case'){ echo 'Case Price';}else{ ?>Unit Price<?php };?></span>
								...
								<div class="b_dropdown">
									<?php if(!empty($product_unit_price)){ ?>
									...
									<?php };?>
									<?php if(!empty($product_case_price)){ ?>
						...
						<button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none  focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 w-10">
					...
					<div class="flex items-center gap-4">
						<div class="flex items-center border rounded-md q_block">
							<button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none  focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-10 w-10 minus">
								<span >-</span>
							</button>
					...
					<button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none  focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 w-full add_to_cart" data-product_id="<?php echo $product_id;?>" data-quantity="1" data-type="<?php if($product_price_type == 'case'){ echo 'case';}else{ echo 'unit'; };?>">
Add to Cart
					</button>
										...
										<div class="p-2">
											<div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow max-w-[160px]">
												<div class="relative">
													...
													<button class="absolute top-2 right-2 bg-white hover:bg-gray-100 text-gray-800 p-1 rounded-full shadow-lg transition-colors">
												...
												<div class="p-2">
													...
													<div class="mt-2 flex flex-col gap-2">
														<div class="flex flex-col gap-1 closest_price">
															<div class="b_select_style">
																<button type="button" role="combobox" aria-controls="radix-:r23:" aria-expanded="false" aria-autocomplete="none" dir="ltr" data-state="closed" class="flex items-center justify-between rounded-md border border-input bg-white px-3 py-2 ring-offset-background placeholder:text-muted-foreground focus:outline-none  focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&amp;>span]:line-clamp-1 w-24 h-6 text-xs">
																	<span style="pointer-events: none;" class="to_type_price"><?php echo $s_p['price_type'];?></span>
														...
														<a href="<?php echo $s_p['href'];?>" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-colors focus-visible:outline-none  focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 text-primary-foreground px-4 bg-[#022785] hover:bg-[#022785]/90 text-xs py-0.5 h-6">
Details</a>
													</div>
												</div>
											</div>
		...
		<div class="border rounded-lg p-6">
			...
			<div class="relative" id="carousel_like">
				<div class="relative px-12 w-full carousel swiper-viewport">
										...
										<div class="p-2">
											...
											<div class="mt-2 flex flex-col gap-2">
														...
														<div class="flex flex-col gap-1 closest_price">
															<div class="b_select_style">
																<button type="button" role="combobox" aria-controls="radix-:r23:" aria-expanded="false" aria-autocomplete="none" dir="ltr" data-state="closed" class="flex items-center justify-between rounded-md border border-input bg-white px-3 py-2 ring-offset-background placeholder:text-muted-foreground focus:outline-none  focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&amp;>span]:line-clamp-1 w-24 h-6 text-xs">
																	<span style="pointer-events: none;" class="to_type_price"><?php echo $l_p['price_type'];?></span>
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down h-4 w-4 opacity-50"><path d="m6 9 6 6 6-6"></path></svg>
																</button>
																<div class="b_dropdown">
												...
												<a href="<?php echo $l_p['href'];?>" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-colors focus-visible:outline-none  focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 text-primary-foreground px-4 bg-[#022785] hover:bg-[#022785]/90 text-xs py-0.5 h-6">Details</a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="absolute inset-y-0 left-0 right-0 flex items-center justify-center gap-4 pointer-events-none">
						<div class="pointer-events-auto">
							<button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none  focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:text-accent-foreground absolute -left-12 top-1/2 -translate-y-1/2 h-12 w-12 bg-no-repeat bg-center hover:bg-gray-100/50 undefined swiper-button-prev" style="background-image: url(&quot;https://cardioptics.org/wp-content/plugins/jetpack/modules/carousel/images/arrows-2x.png&quot;); background-size: 200%; background-position: 0% 50%;"><span class="sr-only">Previous slide</span>
							</button>
						</div>
						<div class="pointer-events-auto">
							<button class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none  focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:text-accent-foreground absolute -right-12 top-1/2 -translate-y-1/2 h-12 w-12 bg-no-repeat bg-center hover:bg-gray-100/50 undefined swiper-button-next" style="background-image: url(&quot;https://cardioptics.org/wp-content/plugins/jetpack/modules/carousel/images/arrows-2x.png&quot;); background-size: 200%; background-position: 100% 50%;"><span class="sr-only">Next slide</span></button>
