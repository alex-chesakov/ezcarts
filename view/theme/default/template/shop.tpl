...
<!-- no products -->
	<div class="flex-1 flex items-center justify-center">
		<div class="text-center p-8">
			<h2 class="text-2xl font-bold mb-4">No Kitchen Selected</h2>
...
<h1 class="text-3xl font-bold text-gray-900"><?php echo $heading_title;?></h1>
					</div>

					<div class="flex items-center gap-4 w-full md:w-auto">
<!-- search block -->
						<div class="relative flex-1 md:w-[500px]" id="wrap_search_suggest">
...
$(document).ready(function() {
	$('.view_change').on("click",function(){
		...
		$('#catalog_block[data-view], #catalog_block [data-view]').each(function(){
